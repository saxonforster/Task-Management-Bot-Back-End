...
class IntegrationTest(APITestCase):
    ...
    def testPostAndEditDueDate(self):
        ...
        self.client.post("/due-date/1", data={"due_date":"2023, 10, 25, 14, 30"}) 

        self.client.post("/due-date/1", data={"due_date":"2023, 11, 26, 14, 30"})
    ...
    def testPostAndListWithDueDates(self):
        ...
        self.client.post("/due-date/1", data={"due_date":"2023, 10, 26, 14, 30"}) 
        self.client.post("/due-date/2", data={"due_date":"2023, 10, 25, 15, 30"}) 
        self.client.post("/due-date/3", data={"due_date":"2023, 10, 25, 14, 30"}) 
